...
import { scenarioStateConfig, type ActionType } from '@/features/scenarios/data/data'
...
export function ScenarioCardActions({ state, onAction, pendingAction }: ScenarioCardActionsProps) {
    const config = scenarioStateConfig[state]
